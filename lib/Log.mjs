...
export default class Log {
  ...
  /** Static @function debug(data)
    ...
    **/
  static debug(data) {
    if(!this.default.suppress.includes('debug'))
  ...
  /** Static @function error(data)
    ...
    **/
  static error(data) {
    if(!this.default.suppress.includes('error'))
  ...
  /** Static @function info(data)
    ...
    **/
  static info(data) {
    if(!this.default.suppress.includes('info'))
  ...
  /** Static @function success(data)
    ...
    **/
  static success(data) {
    if(!this.default.suppress.includes('success'))
  ...
  /** Static @function warning(data)
    ...
    **/
  static warning(data) {
    if(!this.default.suppress.includes('warning'))
