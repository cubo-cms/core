...
export default class Log {
  ...
  static default = {
    ...
    classes: ['Namespace', undefined]           // Limit the classes that output logging
  };
  ...
  /** Static @function debug(data)
    ...
    **/
  static debug(data) {
    if(!this.default.suppress.includes('debug') && this.default.classes.includes(data.class))
  ...
  /** Static @function error(data)
    ...
    **/
  static error(data) {
    if(!this.default.suppress.includes('error') && this.default.classes.includes(data.class))
  ...
  /** Static @function info(data)
    ...
    **/
  static info(data) {
    if(!this.default.suppress.includes('info') && this.default.classes.includes(data.class))
  ...
  /** Static @function success(data)
    ...
    **/
  static success(data) {
    if(!this.default.suppress.includes('success') && this.default.classes.includes(data.class))
  ...
  /** Static @function warning(data)
    ...
    **/
  static warning(data) {
    if(!this.default.suppress.includes('warning') && this.default.classes.includes(data.class))
