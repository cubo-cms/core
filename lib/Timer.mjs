...
export default class Timer {
  ...
  /** static @function on(delay,process,param)
    ...
    **/
  static on(delay = Timer.default.delay, process, param = {}) {
    return setTimeout(process, Timer.parse(delay), param);
  }
  /** static @function onEvery(delay,process,param)
    ...
    * @return {object} - timer object
    **/
  static onEvery(delay = Timer.default.delay, process, param = {}) {
    return setInterval(process, Timer.parse(delay), param);
  }
  ...
  static parse(delay) {
    if(typeof delay === 'string') {
      switch(delay[delay.length - 1]) {
        ...
        default:
          return parseInt(Time.default.delay, 10);
      }
    } else {      // Expect seconds
      return delay * 1000;
    }
